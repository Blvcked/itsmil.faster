    ...
    <button class="scroll-progress back-to-top" type="button">
        <div class="scroll-progress__bar">
            <span class="scroll-progress__icon">
                <svg class="inline-svg inline-svg--fill" xmlns="http://www.w3.org/2000/svg" width="19.028" height="19.028">
                    <g>
                        <path d="M19.028 9.514A9.514 9.514 0 1 1 9.514 0a9.513 9.513 0 0 1 9.514 9.514ZM9.514 2.793a6.726 6.726 0 1 0 6.726 6.726 6.726 6.726 0 0 0-6.726-6.726Z"/>
                        <path d="M12.741 9.054A2.639 2.639 0 0 1 10.31 5.39a4.2 4.2 0 1 0 3.41 4.124 4.121 4.121 0 0 0-.064-.644 2.62 2.62 0 0 1-.915.184Z"/>
                    </g>
                </svg>
            </span>
        </div>
